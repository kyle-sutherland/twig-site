    ...
    <main>
      ...
      <div className="justify-center">
        <div className=" bg-emerald-950">
          <div className="max-w-7xl mx-auto px-4 py-24 text-lg">
            <p className="pb-10">
            ...
            <p className="pb-10">
              Our mission is to support workers from the bottom up and to build
              solidarity and representation across company lines. We are
              volunteer-run and are spearheading a sectoral culture shift toward
              worker empowerment and transparency. We aim to educate and empower
              workers to both support each other and be critical of the
              colonial, patriarchal and capitalist aspects of this industry and
              the harm they cause.
            </p>
            ...
            <p className="pb-10">
              Notre mission est de soutenir les travailleuses et travailleurs à
              partir de la base et de construire une solidarité et une
              représentation au-delà des frontières entre les entreprises. Notre
              groupe est autogéré bénévolement par ses membres et nous
              ...
              par les travailleuses et travailleurs. Nous visons à se co-éduquer
              et à nous donner les moyens, en tant que travailleuses et
              travailleurs, de nous soutenir mutuellement et de critiquer les
