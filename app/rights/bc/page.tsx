...
export default function BCRightsPage() {
  const bcData = getProvinceBySlug("bc");
  ...
  return (
    <main>
      <PageHero title="Know Your Rights - British Columbia" height="short" />
      ...
      <ContentSection variant="white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none mb-12">
            <p className="text-lg text-gray-800">{bcData.intro.en}</p>
          </div>
        </div>
      </ContentSection>
      ...
      <ContentSection variant="grey">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {bcData.governmentLinks.map((link, index) => (
      ...
      <ContentSection variant="green">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {bcData.ngoLinks.map((link, index) => (
      ...
      <ContentSection variant="grey">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {bcData.standards.map((standard, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow">
