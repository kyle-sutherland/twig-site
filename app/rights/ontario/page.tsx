...
export default function OntarioRightsPage() {
  const ontarioData = getProvinceBySlug("ontario");
  ...
  return (
    <main>
      <PageHero title="Know Your Rights - Ontario" height="short" />
      ...
      <ContentSection variant="white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none mb-12">
            <p className="text-lg text-gray-800">{ontarioData.intro.en}</p>
          </div>
        </div>
      </ContentSection>
      ...
      <ContentSection variant="grey">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {ontarioData.governmentLinks.map((link, index) => (
      ...
      <ContentSection variant="green">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {ontarioData.ngoLinks.map((link, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow">
                <h3 className="heading text-xl text-gray-900 mb-2">
                  <a
                    href={link.url}
      ...
      <ContentSection variant="grey">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {ontarioData.standards.map((standard, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow">
