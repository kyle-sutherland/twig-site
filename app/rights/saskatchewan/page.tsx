...
export default function SaskatchewanRightsPage() {
  const saskatchewanData = getProvinceBySlug("saskatchewan");
  ...
  return (
    <main>
      <PageHero title="Know Your Rights - Saskatchewan" height="short" />
      ...
      <ContentSection variant="white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none mb-12">
            <p className="text-lg text-gray-800">{saskatchewanData.intro.en}</p>
          </div>
        </div>
      </ContentSection>
      ...
      <ContentSection variant="grey">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {saskatchewanData.governmentLinks.map((link, index) => (
      ...
      <ContentSection variant="green">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {saskatchewanData.ngoLinks.map((link, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow">
                <h3 className="heading text-xl text-gray-900 mb-2">
                  <a
                    href={link.url}
      ...
      <ContentSection variant="grey">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {saskatchewanData.standards.map((standard, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow">
