...
export default function NewfoundlandLabradorRightsPage() {
  const data = getProvinceBySlug("newfoundland-labrador");
  ...
  return (
    <main>
      <PageHero
        title={{ en: "Know Your Rights — Newfoundland and Labrador", fr: "Connaissez vos droits — Terre-Neuve-et-Labrador" }}
        height="short"
      />
