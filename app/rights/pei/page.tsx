...
export default function PEIRightsPage() {
  const data = getProvinceBySlug("pei");
  ...
  return (
    <main>
      <PageHero
        title={{ en: "Know Your Rights — Prince Edward Island", fr: "Connaissez vos droits — Île-du-Prince-Édouard" }}
        height="short"
      />
