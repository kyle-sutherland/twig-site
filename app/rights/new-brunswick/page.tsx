...
export default function NewBrunswickRightsPage() {
  const data = getProvinceBySlug("new-brunswick");
  ...
  return (
    <main>
      <PageHero
        title={{ en: "Know Your Rights — New Brunswick", fr: "Connaissez vos droits — Nouveau-Brunswick" }}
        height="short"
      />
