...
export default function NovaScotiaRightsPage() {
  const data = getProvinceBySlug("nova-scotia");
  ...
  return (
    <main>
      <PageHero
        title={{ en: "Know Your Rights — Nova Scotia", fr: "Connaissez vos droits — Nouvelle-Écosse" }}
        height="short"
      />
